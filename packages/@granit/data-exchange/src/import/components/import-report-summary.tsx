  ...
  return (
    <div data-slot="import-report-summary" className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 text-sm sm:grid-cols-3">
        ...
        <StatItem label="Succeeded" value={report.succeededRows} className="text-green-600" />
        <StatItem label="Failed" value={report.failedRows} className={cn(hasErrors && 'text-red-600')} />
