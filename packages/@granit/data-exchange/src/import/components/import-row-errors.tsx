...
import type { ImportRowError, ImportRowErrorKind } from '../types/import-report.js';
...
const KIND_VARIANTS: Record<ImportRowErrorKind, 'default' | 'secondary' | 'destructive' | 'outline'> = {
