...
| Pattern                         | Fichier                                               | Rôle                                                     |
| ------------------------------- | ----------------------------------------------------- | -------------------------------------------------------- |
| [Adapter](structure/adapter.md) | `useKeycloakInit` dans `@granit/react-authentication` | Adapter l'API Keycloak native vers des hooks React typés |
...
| [Observer](behaviour/observer.md)       | Callbacks lifecycle dans `@granit/react-authentication` | Réagir aux événements d'authentification |
